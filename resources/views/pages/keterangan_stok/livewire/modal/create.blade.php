            ...
            <div class="modal-content bg-white">
                ...
                <div class="modal-body">
                    <form autocomplete="off">
                        <div class="mb-20">
                            <label class="label fs-16 mb-2" for="ccaption">Caption</label>
                            <div class="form-group">
                                <input type="text" wire:model.lazy="caption" class="form-control @error('caption') is-invalid @enderror" id="ccaption">
                                @error('caption')
                        ...
                        <div class="mb-20">
                            <label class="label fs-16 mb-2" for="cref">Referensi</label>
                            <div class="form-group">
                                <select wire:model.lazy="referensi" class="form-select form-control @error('referensi') is-invalid @enderror" id="cref">
                                    <option value="">...</option>
