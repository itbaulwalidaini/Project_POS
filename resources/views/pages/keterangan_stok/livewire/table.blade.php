<div>
    ...
    <div class="default-table-area mx-minus-1">
            ...
            <table class="table align-middle">
                <thead>
                    <tr>
                        ...
                        <th class="fw-medium" scope="col">Caption</th>
                        <th class="fw-medium" scope="col">Referensi</th>
                        <th class="fw-medium" scope="col">Deskripsi</th>
                        <th class="fw-medium text-start" scope="col">Menu</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($keterangan as $baris)
                        <tr>
                            <td class="text-body">
                                {{ str_pad($keterangan->firstItem() + $loop->index, 2, '0', STR_PAD_LEFT) }}.</td>
                            <td class="text-body">{{ $baris->caption }}</td>
                            <td class="text-body">{{ $baris->referensi }}</td>
        ...
        <div
            ...
            {{ $keterangan->links('vendor.pagination.custom') }}
        </div>
    </div>
</div>
