                ...
                <div class="modal-body">
                    <form autocomplete="off">
                        ...
                        <div class="mb-0">
                            ...
                            <div class="form-group">
                                <textarea wire:model.lazy="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="cdeskripsi"
                                    placeholder="deskripsi opsional diisi" style="height: 100px"></textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
