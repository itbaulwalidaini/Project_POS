                    ...
                    <form autocomplete="off">
                        <div class="mb-20">
                            ...
                            <div class="form-group">
                                <input wire:model.lazy="nama" type="text" class="form-control @error('nama') is-invalid @enderror" id="enama">
                                @error('nama')
                        ...
                        <div class="mb-20">
                            <label class="label fs-16 mb-2" for="ekat">Kategori Induk</label>
                            <div class="form-group">
                                <select wire:model.lazy="parent_id" class="form-select form-control @error('parent_id') is-invalid @enderror" id="ekat">
                        ...
                        <div class="mb-0">
                            <label class="label fs-16 mb-2" for="estatus">Status</label>
