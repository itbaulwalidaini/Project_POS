        ...
        <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
            <div class="modal-content bg-white">
                <div class="modal-header">
                    <h1 class="modal-title fs-4" id="modalTambah">Stok Opname</h1>
                    <button type="button" class="btn-close" @if($this->adaDataInput()) onclick="tutupModalAdd()" @else data-bs-dismiss="modal" @endif></button>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="form-group">
                                            <textarea wire:model.lazy="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="note"
...
<script>
    ...
    window.tutupModalAdd = async function() {
