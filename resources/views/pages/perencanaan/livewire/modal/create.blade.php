                    ...
                    <form autocomplete="off">
                        <div class="col-lg-12">
                            <div class="border rounded p-2 bg-default align-items-center mb-3">
                                <div class="mb-0">
                                    <div class="mb-3">
                                        <label class="label fs-16 mb-2" for="ccar">Cari Produk</label>
                                        <div class="row g-3">
                                            <div class="col-lg-5">
                                                <input type="text" wire:model.lazy="sku" wire:keydown.enter="setKode" wire:change="setKode" id="ccar"
                            ...
                            <div class="mt-3 mb-0">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label class="label fs-16 mb-2" for="ccat">Catatan</label>
                                        <div class="form-group">
                                            <textarea wire:model.lazy="catatan" class="form-control @error('catatan') is-invalid @enderror" id="ccat"
