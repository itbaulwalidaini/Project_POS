...
@section('tabs', 'Kelompok Satuan')
@section('menu-opened', 'Kelompok Satuan')
@section('menu', 'Referensi')
@section('submenu', 'Kelompok Satuan')
@section('content')
<div class="row">
    <div class="col-xxl-6">
        <div class="card bg-white rounded-10 border border-white mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-17-custom">
                <h3>Data Kelompok Satuan</h3>
            ...
            <livewire:kelompok-satuan.table />
        </div>
    </div>
</div>

<!-- panggil komponen modal -->
<livewire:kelompok-satuan.create />
<livewire:kelompok-satuan.edit />
@endsection
